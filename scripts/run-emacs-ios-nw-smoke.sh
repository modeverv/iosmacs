...
lisp_load_path="${lisp_dir}:${lisp_dir}/emacs-lisp:${lisp_dir}/progmodes:${lisp_dir}/language:${lisp_dir}/international:${lisp_dir}/textmodes:${lisp_dir}/vc:${lisp_dir}/calendar:${lisp_dir}/term:${lisp_dir}/mail:${lisp_dir}/net:${lisp_dir}/url:${lisp_dir}/gnus:${lisp_dir}/use-package:${lisp_dir}/obsolete"
