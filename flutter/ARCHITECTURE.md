...
or mounted for the native NW process. When an exchange folder is selected,
normal Workspace Export writes the prepared file or zip into that tree through
